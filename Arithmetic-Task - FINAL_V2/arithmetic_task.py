...
if __name__ == "__main__":
    ...
    n_runs = exp_info["Number of Evaluation Runs"]
    ...
    config_files = sorted(glob(op.join(script_dir, "config", language_stimuli, "config_*.tsv")))
    ...
    for curr_run in run_loop:
        ...
        for curr_trial in trial_loop:
            ...
            feedback_type = config_df.loc[trial_num, "feedback_" + str(run_label)]
